    ...
    <div class="item slides active">
      ...
      <div class="hero">
        <hgroup>
         ...
         <a href="mycourses.php" class="wow slideOutLeft btn btn-hero btn-lg" >my courses</a>
         <a href="courses.php" class="btn btn-hero btn-lg wow slideOutRight" >join course</a>
         <br>
