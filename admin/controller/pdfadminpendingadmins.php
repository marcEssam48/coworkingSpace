...
$pdf->writeHTML("<h1>All Pendding Admin Report </h1>", true, false, true, false, '');
...
$result = mysqli_query($con,"SELECT * FROM users WHERE regstatus=0 AND groupid=1");
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('AllPenddingAdminsReport.pdf', 'I');
//============================================================+
// END OF FILE
//============================================================+
?>